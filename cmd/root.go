...
var RootCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		//
		if err := common.Database.AutoMigrate(&models.Form{}); err != nil {
			logger.Warningf("%+v", err)
		}
...
`,
					...
					if _, err = models.CreateEmailTemplate(common.Database, &models.EmailTemplate{
						Enabled: false,
						Type:    common.NOTIFICATION_TYPE_ADMIN_FREE_SAMPLES_ORDERED,
						Topic:   "Free Samples ordered",
						Message: `<!DOCTYPE HTML PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN"
  "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml"
      xmlns:o="urn:schemas-microsoft-com:office:office">
<head>
  ...
  <!--[if !mso]><!-->
  <meta http-equiv="X-UA-Compatible" content="IE=edge"><!--<![endif]-->
  <title>Free Samples ordered</title>
                    ...
                    <tr>
                      <td
                        ...
                        <div class="v-text-align"
                             style="color: #47484b; line-height: 140%; text-align: center; word-wrap: break-word;">
                          <p style="font-size: 14px; line-height: 140%;"><strong><span
                            style="font-size: 30px; line-height: 42px;">Free Samples ordered!</span></strong></p>
                        </div>
                    ...
                    <tr>
                      <td
                        ...
                        <div class="v-text-align"
                             style="color: #615e5e; line-height: 140%; text-align: left; word-wrap: break-word;">
                          <p style="font-size: 14px; line-height: 140%;"><strong><span
                            style="font-size: 14px; line-height: 19.6px;">SAMPLES</span></strong></p>
                        </div>
                    ...
                    <tr>
                      <td
                        ...
                        <div class="v-text-align"
                             style="color: #615e5e; line-height: 140%; text-align: right; word-wrap: break-word;">
                          <p style="font-size: 14px; line-height: 140%;"><strong><span
                            style="font-size: 14px; line-height: 19.6px;"></span></strong></p>
                        </div>
                    ...
                    <tr>
                      <td
                        ...
                        <div class="v-text-align"
                          ...
                          <p style="font-size: 14px; line-height: 140%;"><strong><span
                            style="font-size: 14px; line-height: 19.6px;">Shipping:</span></strong></p>
                          <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 14px; line-height: 19.6px;">{{.Address.Name}}&nbsp;{{.Address.Lastname}}</span></p>
                          <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 14px; line-height: 19.6px;">{{.Address.Address}}&nbsp;{{.Address.City}}&nbsp;{{.Address.Country}}</span></p>
                          <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 14px; line-height: 19.6px;">ZIP: {{.Address.Zip}}</span></p>
                          <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 14px; line-height: 19.6px;">Phone: {{.Address.Phone}}</span></p>
                          <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 14px; line-height: 19.6px;">Email: {{.Address.Email}}</span></p>
                        </div>

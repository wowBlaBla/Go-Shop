...
func GetProductFull(connector *gorm.DB, id int) (*Product, error) {
	db := connector
	var product Product
	if err := db.Preload("Categories").Preload("Parameters").Preload("Parameters.Option").Preload("Parameters.Value").Preload("Properties").Preload("Properties.Option").Preload("Properties.Rates").Preload("Properties.Rates.Value").Preload("Prices").Preload("Prices.Rates").Preload("Prices.Rates.Property").Preload("Prices.Rates.Value").Preload("Files").Preload("Images").Preload("Variations").Preload("Variations.Properties").Preload("Variations.Properties.Option").Preload("Variations.Properties.Rates").Preload("Variations.Properties.Rates.Value").Preload("Variations.Prices").Preload("Variations.Prices.Rates").Preload("Variations.Prices.Rates.Property").Preload("Variations.Prices.Rates.Value").Preload("Variations.Images").Preload("Variations.Files").Preload("Variations.Time").Preload("Vendor").Preload("Time").Preload("Tags").First(&product, id).Error; err != nil {
		return nil, err
	}
